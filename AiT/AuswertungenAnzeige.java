...
public class AuswertungenAnzeige {
		      ...
		      resultSet = statement
		       ...
		       while(resultSet.next()){
		    	   ...
		    	   if(tag.equals(heutigeTag)){	
		    		   ...
		    		   row1 = new Vector<String>(c);
		    		   
		    		   for(int i = 1; i <= c; i++){
		    			   row1.add(resultSet.getString(i));
		    		   }
		    		   /**
		        ...
		        */
		       aitjFrame.table = new JTable(data1,column);
