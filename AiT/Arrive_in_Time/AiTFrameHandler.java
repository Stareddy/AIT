...
public class AiTFrameHandler implements ActionListener {
	 ...
	 */
	Arrive_in_Time.AiTJFrame aitjFrame;
	 ...
	 * @param aitjframe
	 */
	public AiTFrameHandler(Arrive_in_Time.AiTJFrame aitjframe) {
	...
	private void AnwendungStarten() {
		if(ausgangsWert>neuerWert){
			Arrive_in_Time.AiTHauptklasse startJob = new Arrive_in_Time.AiTHauptklasse(aitjFrame);
			startJob.setWert2(2);
